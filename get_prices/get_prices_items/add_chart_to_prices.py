...
import prices_items as profitable_items
import math
...
def get_charts():
    ...
    profitables_df = read_profitables_file(
        "profit_sheets\\Most_Profitable_Items.xlsx")
    ...
    save_to_file(profitables_chart, "Most_Profitable_Charts")

    new_df = profitables_df.loc[~((profitables_df['buy_days_totalled'] == 0) | (profitables_df['sell_days_totalled'] == 0)),:]
    save_to_file(new_df, "Most_Profitable_Charts_Strict")
