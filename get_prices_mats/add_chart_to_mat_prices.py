...
import math
import prices_mats as profitables
...
def get_charts():
    ...
    profitables_df = read_profitables_file(
        "profit_sheets\\Most_Profitable_Mats.xlsx")
    ...
    save_to_file(profitables_chart, "Most_Profitable_Mats_Charts")

    new_df = profitables_df.loc[~((profitables_df['buy_days_totalled'] == 0) | (profitables_df['sell_days_totalled'] == 0)),:]
    save_to_file(new_df, "Most_Profitable_Mats_Charts_Strict")
